    ...
    <div class="product-page">
        ...
        <div class="product-layout">
            ...
            <div class="product-gallery">
                <img src="../../assets/ScrubberMachine/HAP4045.png" alt="HC 4045 Walk Behind Floor Scrubber Drier"
                    class="main-image" />
                <span class="badge">
            ...
            <div class="product-info">
                ...
                <p class="description">
                    <strong>HAP 4045</strong> is a walk behind floor scrubber drier that provides the best cleaning and
                    flexibility for larger areas. It is very user-friendly and efficient, featuring a stainless steel
                    chassis and a power head folding system.
                </p>
                ...
                <div class="key-specs">
                    ...
                    <div class="spec-item">
                        ...
                        <div>
                            ...
                            <span class="value">Light to Medium Tasks</span>
                        </div>
                    </div>
                    <div class="spec-item">
                        ...
                        <div>
                            ...
                            <span class="value">Walk Behind</span>
                        </div>
                    </div>
                    <div class="spec-item">
        ...
        <div class="product-tabs">
            ...
            <div class="tab-content active" id="overview">
                ...
                <p>
                    The <strong>HAP 4045</strong> is a walk behind floor scrubber drier that provides the best cleaning
                    and flexibility for larger areas. It is very user-friendly and efficient, making it the ideal choice
                ...
                <p>
                    ...
                    for easy storage and transport. The HAP 4045 is ideally suited for indoor cleaning from light to
                    medium tasks such as railway stations, warehouses, educational institutions, small supermarkets, and
                    more.
                </p>
                <p>
                    With its adjustable handle, the machine can be used at your convenient height, reducing operator
                    fatigue and improving productivity.
                </p>
            ...
            <div class="tab-content" id="advantages">
                ...
                <div class="advantages-grid">
                    <div class="advantage-item">
                        ...
                        <h4>Handle Adjustable</h4>
                        <p>Can be used as per your convenient height</p>
                    </div>
                    <div class="advantage-item">
                        <i class="ti ti-money"></i>
                        <h4>Man Power Reduction</h4>
                        <p>Significant reduction in labor costs</p>
                    </div>
                    <div class="advantage-item">
                        <i class="ti ti-tools"></i>
                        <h4>Easy Brush Fitting</h4>
                        <p>Easy to fit brush in machine</p>
                    </div>
                    <div class="advantage-item">
                        <i class="ti ti-package"></i>
                        <h4>Standard Accessories</h4>
                        <p>Standard accessories are easily available</p>
                    </div>
                    <div class="advantage-item">
                    ...
                    <div class="advantage-item">
                        ...
                        <p>Easy storage and transport with folding system</p>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-content" id="specifications">
                ...
                <table class="spec-table">
                    ...
                    <tr>
                        <td>Applications</td>
                        <td>Light to Medium Indoor Cleaning</td>
                    </tr>
                    <tr>
            ...
            <div class="tab-content" id="applications">
                ...
                <ul>
                    ...
                    <li><i class="ti ti-building"></i> Mall Cleaning</li>
                    <li><i class="ti ti-building"></i> Society Complexes</li>
                    <li><i class="ti ti-building-factory"></i> Industrial Floor Scrubbing with Vacuuming</li>
                    <li><i class="ti ti-train"></i> Railway Stations</li>
