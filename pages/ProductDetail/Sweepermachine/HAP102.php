...
<head>
    ...
    <title>HAP 102 Walk Behind Sweeper Machine | Industrial Floor Sweeper | Hygiene Apparatus & Service</title>

    <meta name="description"
        content="Buy the HAP 102 Walk Behind Sweeper Machine from Hygiene Apparatus & Service, Chennai. Industrial floor sweeper with 80 L hopper capacity, 6300 m²/h productivity and efficient cleaning for warehouses, factories and commercial facilities.">

    <meta name="keywords"
        content="HAP 102 Walk Behind Sweeper Machine, Industrial Sweeper Machine, Floor Sweeper Machine, Manual Sweeper, Warehouse Sweeper, Commercial Cleaning Machine, Cleaning Equipment Chennai, Hygiene Apparatus & Service">

    <meta name="author" content="Hygiene Apparatus & Service">

    <meta name="robots" content="index, follow">

    <link rel="canonical" href="https://hygieneapparattus.com/pages/ProductDetail/SweeperMachine/HAP102.php">

    <meta property="og:type" content="product">

    <meta property="og:title" content="HAP 102 Walk Behind Sweeper Machine">

    <meta property="og:description"
        content="Industrial walk behind floor sweeper with 80 L hopper capacity, 6300 m²/h productivity and maintenance-free operation.">

    <meta property="og:url" content="https://hygieneapparattus.com/pages/ProductDetail/SweeperMachine/HAP102.php">

    <meta property="og:image" content="https://hygieneapparattus.com/pages/assets/Sweepermachine/HAP102.png">

    <meta name="twitter:card" content="summary_large_image">

    <meta name="twitter:title" content="HAP 102 Walk Behind Sweeper Machine">
    ...
    <meta name="twitter:image" content="https://hygieneapparattus.com/pages/assets/Sweepermachine/HAP102.png">
    ...
    <div class="product-page">
        ...
        <div class="product-layout">
            ...
            <div class="product-gallery">
                <img src="../../assets/Sweepermachine/HAP102.png" alt="HAP 102 Walk Behind Sweeper Machine"
                    class="main-image" />
                <span class="badge">
            ...
            <div class="product-info">
                ...
                <h1>HAP 102 Walk Behind Sweeper Machine</h1>
                <p class="description">
                    <strong>HAP 102</strong> is a walk behind manual sweeper machine that is better than manual sweeping
                    on roads or outdoor areas. It is <strong>10 times faster</strong> than conventional sweeping
                    methods, saving time and labor costs.
                </p>
        ...
        <div class="product-tabs">
            ...
            <div class="tab-content active" id="overview">
                ...
                <p>
                    The <strong>HAP 102</strong> is a walk behind manual sweeper machine that is better than manual
