...
<head>
    ...
    <title>HAP 700 Floor Scrubber Machine | Industrial Floor Cleaning Machine | Hygiene Apparatus & Service</title>

    <meta name="description"
        content="Buy the HAP 700 Floor Scrubber Machine from Hygiene Apparatus & Service, Chennai. Heavy-duty industrial floor scrubber for scrubbing, buffing, polishing and carpet shampooing in commercial and industrial environments.">

    <meta name="keywords"
        content="HAP 700 Floor Scrubber Machine, Floor Scrubber Chennai, Industrial Floor Scrubber, Floor Cleaning Machine, Floor Polishing Machine, Commercial Scrubber Machine, Cleaning Equipment Chennai, Hygiene Apparatus & Service">

    <meta name="author" content="Hygiene Apparatus & Service">

    <meta name="robots" content="index, follow">

    <link rel="canonical" href="https://hygieneapparattus.com/pages/ProductDetail/Scrubber/HAP700.php">

    <meta property="og:type" content="product">

    <meta property="og:title" content="HAP 700 Floor Scrubber Machine">

    <meta property="og:description"
        content="Heavy-duty industrial floor scrubber for scrubbing, polishing, buffing and carpet shampooing.">

    <meta property="og:url" content="https://hygieneapparattus.com/pages/ProductDetail/Scrubber/HAP700.php">

    <meta property="og:image" content="https://hygieneapparattus.com/pages/assets/Scrubber/HAP700.png">

    <meta name="twitter:card" content="summary_large_image">

    <meta name="twitter:title" content="HAP 700 Floor Scrubber Machine">

    <meta name="twitter:description"
        content="Industrial floor scrubber machine for commercial and industrial floor cleaning applications.">

    <meta name="twitter:image" content="https://hygieneapparattus.com/pages/assets/Scrubber/HAP700.png">
    ...
    <div class="product-page">
        ...
        <div class="product-layout">
            ...
            <div class="product-gallery">
                <img src="../../assets/Scrubber/HAP700.png" alt="HAP 700 Floor Scrubber Machine" class="main-image" />
                <span class="badge">
            ...
            <div class="product-info">
                ...
                <h1>HAP 700 Floor Scrubber Machine</h1>
                <p class="description">
                    <strong>HAP 700</strong> Floor Scrubber Machine is a heavy-duty industrial cleaning machine designed
                    for deep cleaning, scrubbing, buffing, polishing and dry foam carpet shampooing. It is suitable for
                    commercial buildings, factories, hospitals, shopping malls, hotels and all types of hard floor
        ...
        <div class="product-tabs">
            ...
            <div class="tab-content active" id="overview">
                ...
                <p>
                    The <strong>HAP 700</strong> is a heavy-duty floor scrubber machine that enables you to improve your
                    floor cleaning and care tasks. It provides superb performance, designed especially for aggressive
                    deep cleaning.
                </p>
                <p>
                    The HAP 700 offers multipurpose floor applications for all types of hard floors including scrubbing,
                    buffing, polishing, and dry foam carpet shampooing. Built with durability and performance in mind,
                    this machine is perfect for professional and industrial use.
                </p>
