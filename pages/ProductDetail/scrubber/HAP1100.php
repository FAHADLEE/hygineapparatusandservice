...
<head>
    ...
    <title>HAP 1100 Floor Scrubber Machine | Industrial Floor Cleaning Machine | Hygiene Apparatus & Service</title>

    <meta name="description"
        content="Buy the HAP 1100 Floor Scrubber Machine from Hygiene Apparatus & Service, Chennai. Heavy-duty industrial floor scrubber for scrubbing, buffing, polishing and carpet shampooing in commercial, industrial and warehouse environments.">

    <meta name="keywords"
        content="HAP 1100 Floor Scrubber Machine, Industrial Floor Scrubber, Floor Cleaning Machine Chennai, Floor Polishing Machine, Heavy Duty Floor Scrubber, Commercial Floor Scrubber, Cleaning Equipment Chennai, Hygiene Apparatus & Service">

    <meta name="author" content="Hygiene Apparatus & Service">

    <meta name="robots" content="index, follow">

    <link rel="canonical" href="https://hygieneapparattus.com/pages/ProductDetail/Scrubber/HAP1100.php">

    <meta property="og:type" content="product">

    <meta property="og:title" content="HAP 1100 Floor Scrubber Machine">

    <meta property="og:description"
        content="Heavy-duty industrial floor scrubber for scrubbing, polishing, buffing and carpet shampooing.">

    <meta property="og:url" content="https://hygieneapparattus.com/pages/ProductDetail/Scrubber/HAP1100.php">

    <meta property="og:image" content="https://hygieneapparattus.com/pages/assets/Scrubber/HAP1100.png">

    <meta name="twitter:card" content="summary_large_image">

    <meta name="twitter:title" content="HAP 1100 Floor Scrubber Machine">

    <meta name="twitter:description"
        content="Industrial floor scrubber machine for commercial, warehouse and industrial cleaning applications.">

    <meta name="twitter:image" content="https://hygieneapparattus.com/pages/assets/Scrubber/HAP1100.png">
    ...
    <div class="product-page">
        ...
        <div class="product-layout">
            ...
            <div class="product-gallery">
                <img src="../../assets/Scrubber/HAP1100.png" alt="HAP 1100 Floor Scrubber Machine" class="main-image" />
                <span class="badge">
                    <i class="ti ti-star"></i> Industrial Grade
                </span>
                <span class="badge-power">
                    <i class="ti ti-bolt"></i> Heavy Duty Motor
                </span>
            </div>
            ...
            <div class="product-info">
                ...
                <h1>HAP 1100 Floor Scrubber Machine</h1>
                <p class="description">
                    <strong>HAP 1100</strong> Floor Scrubber Machine is a heavy-duty industrial cleaning machine
                    designed for deep cleaning, scrubbing, buffing, polishing and dry foam carpet shampooing. It is
                    ideal for factories, warehouses, hospitals, hotels, shopping malls and all commercial hard floor
                ...
                <div class="key-specs">
                    ...
                    <div class="spec-item">
                        ...
                        <div>
                            ...
                            <span class="value">Industrial Grade</span>
                        </div>
                    </div>
                    <div class="spec-item">
        ...
        <div class="product-tabs">
            ...
            <div class="tab-content active" id="overview">
                ...
                <p>
                    The <strong>HAP 1100</strong> is an industrial-grade floor scrubber machine that enables you to
                    improve your floor cleaning and care tasks. It provides superb performance, designed especially for
                    aggressive deep cleaning in demanding environments.
                </p>
                <p>
                    The HAP 1100 offers multipurpose floor applications for all types of hard floors including
                    scrubbing, buffing, polishing, and dry foam carpet shampooing. Built with industrial-grade
                    durability, this machine delivers exceptional performance for professional and industrial use.
                </p>
            ...
            <div class="tab-content" id="advantages">
                ...
                <div class="advantages-grid">
                    ...
                    <div class="advantage-item">
                        ...
                        <p>Industrial-grade motor for aggressive deep cleaning</p>
                    </div>
                    <div class="advantage-item">
                        <i class="ti ti-brush"></i>
                        <h4>Multi-Purpose</h4>
            ...
            <div class="tab-content" id="specifications">
                ...
                <table class="spec-table">
                    ...
                    <tr>
                        <td>Type</td>
                        <td>Industrial Floor Scrubber Machine</td>
                    </tr>
                    <tr>
                        <td>Operation</td>
