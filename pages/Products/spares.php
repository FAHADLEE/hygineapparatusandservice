...
<head>
    ...
    <title>Cleaning Machine Spare Parts | Vacuum Cleaner & Scrubber Spares | Hygiene Apparatus & Service</title>
    <meta name="description"
        content="Explore premium spare parts for vacuum cleaners, scrubber machines, sweepers and commercial cleaning equipment including motors, pads, accessories and replacement components from Hygiene Apparatus & Service.">

    <meta name="keywords"
        content="Cleaning Machine Spares, Vacuum Cleaner Spare Parts, Scrubber Machine Spare Parts, Cleaning Equipment Accessories, Vacuum Motor, Diamond Pads, 3M Pads, Industrial Cleaning Parts, Hygiene Apparatus & Service">

    <meta name="author" content="Hygiene Apparatus & Service">

    <meta name="robots" content="index, follow">

    <link rel="canonical" href="https://hygieneapparattus.com/pages/Products/spares.php">

    <meta property="og:type" content="website">

    <meta property="og:title" content="Cleaning Machine Spare Parts | Hygiene Apparatus & Service">

    <meta property="og:description"
        content="Premium spare parts and accessories for vacuum cleaners, scrubber machines and commercial cleaning equipment.">

    <meta property="og:url" content="https://hygieneapparattus.com/pages/Products/spares.php">

    <meta property="og:image" content="https://hygieneapparattus.com/pages/assets/Spares/Spares1.png">

    <meta name="twitter:card" content="summary_large_image">

    <meta name="twitter:title" content="Cleaning Machine Spare Parts">

    <meta name="twitter:description"
        content="High-quality spare parts, motors, pads and accessories for commercial cleaning equipment.">

    <meta name="twitter:image" content="https://hygieneapparattus.com/pages/assets/Spares/Spares1.png">
...
<body>
    ...
    <div class="product-page">
        ...
        <section class="product-hero">
            <h1>Cleaning Equipment <span>Spare Parts</span></h1>
            <p>
                Explore our complete range of genuine spare parts and accessories for vacuum cleaners, scrubber
                machines, sweepers and other commercial cleaning equipment. Designed for durability, reliable
                performance and easy replacement across industrial and commercial applications.
            </p>
        </section>
        ...
        <div class="product-grid-container">
            <div class="product-grid-title">
                ...
                Our Cleaning Equipment Spare Parts
            </div>
    ...
    <script>
        ...
        const vacuumProducts = [{
            name: "3M Pads",
            image: "../assets/Spares/Spares1.png",

        },
        {
            name: "15 LTR Accessories",
            image: "../assets/Spares/Spares2.png",

        },
        {
            name: "30/60/80 LTR Accessories",
            image: "../assets/Spares/Spares3.png",

        },
        {
            name: "Diamond Pads",
            image: "../assets/Spares/Spares4.png",

        },
        {
            name: "Dry Motor",
            image: "../assets/Spares/Spares5.png",

        },
        {
            name: "Extractor Motor",
            image: "../assets/Spares/Spares6.png",

        },
        {
            name: "Norton Pads",
            image: "../assets/Spares/Spares7.png",

        },
        {
            name: "Single Stage Motor",
            image: "../assets/Spares/spares8.png",

        },
        {
            name: "Vacuum Motor",
            image: "../assets/Spares/Spares9.png",

        },
        {
            name: "Vacuum Motor[AMETEK]",
            image: "../assets/Spares/Spares10.png",

        },
        {
            name: "Vacuum Motor[white]",
            image: "../assets/Spares/Spares11.png",
        ...
        if (grid) {
            vacuumProducts.forEach(product => {
                ...
                card.innerHTML = `
                    <img src="${product.image}" alt="${product.name} | Cleaning Equipment Spare Part | Hygiene Apparatus & Service" class="product-card-image" />
