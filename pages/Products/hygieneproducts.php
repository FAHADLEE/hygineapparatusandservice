...
<head>
    ...
    <title>Hygiene Products | Soap Dispensers, Tissue Dispensers & Washroom Accessories | Hygiene Apparatus & Service
    </title>

    <meta name="description"
        content="Explore premium hygiene products including soap dispensers, tissue dispensers, paper towel dispensers, sanitiser dispensers, room fresheners and washroom accessories from Hygiene Apparatus & Service, Chennai.">

    <meta name="keywords"
        content="Hygiene Products, Soap Dispenser, Tissue Dispenser, Sanitiser Dispenser, Paper Towel Dispenser, Washroom Accessories, Room Freshener, Commercial Hygiene Products, Hygiene Apparatus & Service">

    <meta name="author" content="Hygiene Apparatus & Service">

    <meta name="robots" content="index, follow">

    <link rel="canonical" href="https://hygieneapparattus.com/pages/Products/hygieneproducts.php">

    <meta property="og:type" content="website">

    <meta property="og:title" content="Hygiene Products | Hygiene Apparatus & Service">

    <meta property="og:description"
        content="Professional hygiene products including soap dispensers, tissue dispensers, sanitiser dispensers, room fresheners and washroom accessories for commercial and industrial facilities.">

    <meta property="og:url" content="https://hygieneapparattus.com/pages/Products/hygieneproducts.php">

    <meta property="og:image" content="https://hygieneapparattus.com/pages/assets/hygiene%20products/H-205.jpg">

    <meta name="twitter:card" content="summary_large_image">

    <meta name="twitter:title" content="Hygiene Products | Hygiene Apparatus & Service">

    <meta name="twitter:description"
        content="Premium hygiene products for hospitals, hotels, offices, shopping malls, factories and commercial washrooms.">

    <meta name="twitter:image" content="https://hygieneapparattus.com/pages/assets/hygiene%20products/H-205.jpg">
...
<body>
    ...
    <div class="product-page">
        ...
        <section class="product-hero">
            <h1>Commercial Hygiene Products & <Span>Washroom Accessories</Span></h1>
            <p>
                Hygiene Apparatus & Service offers a wide range of commercial hygiene products including soap
                dispensers, tissue
                dispensers, paper towel dispensers, sanitiser dispensers, room fresheners, washroom accessories
                and
                hygiene
                solutions. Our products are ideal for hospitals, hotels, offices, shopping malls, schools,
                restaurants,
                factories and other commercial facilities where cleanliness and hygiene are essential.
            </p>
        </section>
        ...
        <div class="product-grid-container">
            <div class="product-grid-title">
                ...
                Our Hygiene Products Collection
            </div>
    ...
    <script>
        ...
        {
            name: "HRT Auto Cut Dispenser H-212",
        ...
        {
            name: "Flat Dispenser (Small) H-215",
            image: "../assets/hygiene products/h-215.jpg",

        },
        {
            name: "Flat Dispenser (Medium) H-216",
        ...
        {
            name: "ABS Soap Dispenser (Blue) H-323",
        ...
        {
            name: "Automatic Wall Soap Dispenser H-328",
        ...
        {
            name: "1000 ml Sanitiser Dispenser H-339",
            image: "../assets/hygiene products/h-339.jpg",

        },
        {
            name: "Wall Mounted Sanitiser Dispenser H-340",
        ...
        {
            name: "Air Revitaliser (Medium) H-408",
            image: "../assets/hygiene products/h-408.jpg",

        },
        {
            name: "Automatic Room Freshener (LCD) Big H-407",
            image: "../assets/hygiene products/h-407.jpg",

        },
        {
            name: "Air Revitaliser (Big) H-409",
            image: "../assets/hygiene products/h-409.jpg",

        },
        {
            name: "8″ Magnifying Mirror H-409",
        ...
        {
            name: "Automatic Room Freshener (LCD) Big H-519",
        ...
        {
            name: "Automatic Room Freshener (LCD) Big H-524",
            image: "../assets/hygiene products/h-524.jpg",

        },
        {
            name: "Automatic Room Freshener (LCD) Big H-526",
            image: "../assets/hygiene products/h-526.jpg",

        },
        {
            name: "Automatic Room Freshener (LCD) Big H-528",
        ...
        if (grid) {
            vacuumProducts.forEach(product => {
                ...
                card.innerHTML = `
                    <img src="${product.image}" alt="${product.name} | Hygiene Products | Hygiene Apparatus & Service" class="product-card-image" />
