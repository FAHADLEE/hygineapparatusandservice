...
<head>
    ...
    <title>Commercial Vacuum Cleaners | Industrial Wet & Dry Vacuum Cleaners | Hygiene Apparatus & Service</title>
    <meta name="description"
        content="Explore commercial wet and dry vacuum cleaners for industrial, commercial and professional cleaning applications including factories, hotels, hospitals, offices and warehouses from Hygiene Apparatus & Service.">

    <meta name="keywords"
        content="Commercial Vacuum Cleaner, Industrial Vacuum Cleaner, Wet and Dry Vacuum Cleaner, Industrial Cleaning Equipment, Professional Vacuum Cleaner, Warehouse Vacuum Cleaner, Cleaning Machine, Hygiene Apparatus & Service">

    <meta name="author" content="Hygiene Apparatus & Service">

    <meta name="robots" content="index, follow">

    <link rel="canonical" href="https://hygieneapparattus.com/pages/Products/Vaccumecleaners.php">

    <meta property="og:type" content="website">

    <meta property="og:title" content="Commercial Vacuum Cleaners | Hygiene Apparatus & Service">

    <meta property="og:description"
        content="Professional wet and dry vacuum cleaners for industrial and commercial cleaning applications.">

    <meta property="og:url" content="https://hygieneapparattus.com/pages/Products/Vaccumecleaners.php">

    <meta property="og:image" content="https://hygieneapparattus.com/pages/assets/VaccumeCleaner/HAP380.png">

    <meta name="twitter:card" content="summary_large_image">

    <meta name="twitter:title" content="Commercial Vacuum Cleaners">

    <meta name="twitter:description"
        content="Premium industrial wet and dry vacuum cleaners for factories, hotels, hospitals, warehouses and commercial cleaning.">
...
<body>
    ...
    <div class="product-page">
        ...
        <section class="product-hero">
            <h1>Commercial <span>Vacuum Cleaners</span></h1>
            <p>
                Explore our range of commercial wet and dry vacuum cleaners designed for powerful cleaning in factories,
                warehouses, hotels, hospitals, offices, workshops and industrial facilities. Built for durability, high
                suction performance and professional cleaning applications.
            </p>
        </section>
    ...
    <script>
        ...
        const vacuumProducts = [{
            name: "HAP 380",
            image: "../assets/VaccumeCleaner/HAP380.png",
            page: "../ProductDetail/HAP380.php"

        },
        {
            name: "HAP 260",
            image: "../assets/VaccumeCleaner/HAP260.png",
            page: "../ProductDetail/HAP260.php"

        },
        {
            name: "HAP 30",
            image: "../assets/VaccumeCleaner/HAP30.png",
            page: "../ProductDetail/HAP30.php"
        },
        {
            name: "HAP 15",
            image: "../assets/VaccumeCleaner/HAP15.png",
            page: "../ProductDetail/HAP15.php"
        ...
        if (grid) {
            vacuumProducts.forEach(product => {
                ...
                card.innerHTML = `
                    <img src="${product.image}" alt="${product.name} | Commercial Vacuum Cleaner | Hygiene Apparatus & Service" class="product-card-image" />
