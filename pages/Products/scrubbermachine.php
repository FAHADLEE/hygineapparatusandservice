...
<head>
    ...
    <<title>Commercial Scrubber Machines | Automatic Floor Cleaning Machines | Hygiene Apparatus & Service</title>
        <meta name="description"
            content="Explore commercial scrubber machines for automatic floor cleaning in hospitals, hotels, shopping malls, warehouses, factories and industrial facilities from Hygiene Apparatus & Service.">

        <meta name="keywords"
            content="Commercial Scrubber Machine, Floor Scrubber Machine, Automatic Floor Cleaning Machine, Industrial Scrubber Machine, Walk Behind Scrubber, Cleaning Equipment, Hygiene Apparatus & Service">

        <meta name="author" content="Hygiene Apparatus & Service">

        <meta name="robots" content="index, follow">

        <link rel="canonical" href="https://hygieneapparattus.com/pages/Products/scrubbermachine.php">

        <meta property="og:type" content="website">

        <meta property="og:title" content="Commercial Scrubber Machines | Hygiene Apparatus & Service">

        <meta property="og:description"
            content="Professional automatic scrubber machines for industrial and commercial floor cleaning.">

        <meta property="og:url" content="https://hygieneapparattus.com/pages/Products/scrubbermachine.php">

        <meta property="og:image" content="https://hygieneapparattus.com/pages/assets/ScrubberMachine/HAP5056.png">

        <meta name="twitter:card" content="summary_large_image">

        <meta name="twitter:title" content="Commercial Scrubber Machines">

        <meta name="twitter:description"
            content="Premium automatic scrubber machines for hospitals, factories, shopping malls, warehouses and commercial cleaning.">
...
<body>
    ...
    <div class="product-page">
        ...
        <section class="product-hero">
            <h1>Commercial <span>Scrubber Machines</span></h1>
            <p>
                Explore our range of commercial scrubber machines designed for automatic floor cleaning in hospitals,
                hotels, shopping malls, offices, warehouses, factories and industrial facilities. Built for high
                performance, durability and professional cleaning.
            </p>
            <h2>Professional Automatic Floor Scrubber Machines</h2>

            <p>
                Hygiene Apparatus & Service offers premium commercial scrubber machines for efficient floor cleaning
                across industrial and commercial environments. Our automatic floor scrubbers provide powerful cleaning
                performance for hospitals, hotels, shopping malls, offices, warehouses, factories and manufacturing
                facilities while reducing cleaning time and labour costs.
            </p>
        </section>
        ...
        <div class="product-grid-container">
            <div class="product-grid-title">
                ...
                Our Commercial Scrubber Machines
            </div>
    ...
    <script>
        ...
        const vacuumProducts = [{
            name: "HAP 5056",
            image: "../assets/ScrubberMachine/HAP5056.png",
            page: "../ProductDetail/scrubberMachine/HAP5056.php"

        },
        {
            name: "HAP 6530",
            image: "../assets/ScrubberMachine/HAP6530.png",
            page: "../ProductDetail/scrubberMachine/HAP6530.php"

        },
        {
            name: "HAP 9050",
            image: "../assets/ScrubberMachine/HAP9050.png",
            page: "../ProductDetail/scrubberMachine/HAP9050.php"

        },
        {
            name: "HAP 4045",
            image: "../assets/ScrubberMachine/HAP4045.png",
            page: "../ProductDetail/scrubberMachine/HAP4045.php"

        },
        {
            name: "HAP 2832",
            image: "../assets/ScrubberMachine/HAP2832.png",
            page: "../ProductDetail/scrubberMachine/HAP2832.php"
        ...
        if (grid) {
            vacuumProducts.forEach(product => {
                ...
                card.innerHTML = `
                    <img src="${product.image}" alt="${product.name} | Commercial Scrubber Machine | Hygiene Apparatus & Service" class="product-card-image" />
