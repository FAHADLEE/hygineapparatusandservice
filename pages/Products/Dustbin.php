...
<head>
    ...
    <title>Industrial Dust Bins | Garbage Bins | Waste Management Solutions | Hygiene Apparatus & Service</title>

    <meta name="description"
        content="Explore industrial dust bins, garbage bins, pedal bins, swing bins, mesh bins and waste management solutions from Hygiene Apparatus & Service, Chennai. Durable dust bins for commercial, industrial and public spaces.">

    <meta name="keywords"
        content="Industrial Dust Bin, Garbage Bin, Pedal Bin, Swing Bin, Mesh Bin, Plastic Dust Bin, Waste Management Bin, Commercial Dust Bin, Dust Bin Chennai, Hygiene Apparatus & Service">

    <meta name="author" content="Hygiene Apparatus & Service">

    <meta name="robots" content="index, follow">

    <link rel="canonical" href="https://hygieneapparattus.com/pages/Products/Dustbin.php">

    <meta property="og:type" content="website">

    <meta property="og:title" content="Industrial Dust Bins | Hygiene Apparatus & Service">

    <meta property="og:description"
        content="Professional dust bins and waste management products for hospitals, offices, factories, hotels, schools and commercial facilities.">

    <meta property="og:url" content="https://hygieneapparattus.com/pages/Products/Dustbin.php">

    <meta property="og:image" content="https://hygieneapparattus.com/pages/assets/Dustbin/Dustbin1.png">

    <meta name="twitter:card" content="summary_large_image">

    <meta name="twitter:title" content="Industrial Dust Bins | Hygiene Apparatus & Service">

    <meta name="twitter:description"
        content="High-quality industrial dust bins, garbage bins and waste management products for commercial and industrial applications.">

    <meta name="twitter:image" content="https://hygieneapparattus.com/pages/assets/Dustbin/Dustbin1.png">
...
<body>
    ...
    <div class="product-page">
        ...
        <section class="product-hero">
            <h1>Industrial Dust Bins & <span>Waste Management</span> Products</h1>
            <p>
                Hygiene Apparatus & Service offers a complete range of industrial dust bins, garbage bins, pedal
                bins,
                swing bins, mesh bins and waste management solutions. Our products are suitable for hospitals,
                offices,
                schools, shopping malls, warehouses, factories, hotels and public places, ensuring hygienic
                waste
                collection with durable, high-quality materials.
            </p>
        </section>
                    ...
                    <div class="contact-grid">
                        ...
                        <div class="contact-info-side">
                            ...
                            <div class="info-card">
                                ...
                                <div class="content">
                                    <h4>Location</h4>
                                    <p>DHANALAXMI NAGAR ANEX, 43A, Periya Kolathuvancheri, Iyyappanthangal, Chennai,
                                        Tamil Nadu 600056</p>
    ...
    <script>
        ...
        const vacuumProducts = [{
            name: "Plain Dust Bin D-104",
            image: "../assets/Dustbin/Dustbin1.png",

        },
        {
            name: "Pedal Dust Bin D-107",
            image: "../assets/Dustbin/Dustbin2.png",

        },
        {
            name: "Swing Dust Bin D-110",
            image: "../assets/Dustbin/Dustbin3.png",

        },
        {
            name: "Coated Mesh Dust Bin D-205",
            image: "../assets/Dustbin/Dustbin4.png",

        },
        {
            name: "Mesh Dust Bin D-206",
            image: "../assets/Dustbin/Dustbin5.png",

        },
        {
            name: "240 L Plastic Dust Bin D-214",
            image: "../assets/Dustbin/Dustbin6.png",

        },
        {
            name: "660 L Industrial Dust Bin D-219",
            image: "../assets/Dustbin/Dustbin7.png",

        },
        {
            name: "1200 L Industrial Dust Bin D-220",
            image: "../assets/Dustbin/Dustbin8.png",

        },
        {
            name: "Heavy Duty Garbage Bin D-221",
            image: "../assets/Dustbin/Dustbin9.png",

        },
        {
            name: "25 L Push Dust Bin D-225",
            image: "../assets/Dustbin/Dustbin10.png",

        },
        {
            name: "Swing Dust Bin D-227",
            image: "../assets/Dustbin/Dustbin11.png",

        },
        {
            name: "8 L / 10 L Dust Bin D-229",
            image: "../assets/Dustbin/Dustbin12.png",

        },
        {
            name: "Feminine Hygiene Bin D-232",
            image: "../assets/Dustbin/Dustbin13.png",
        ...
        if (grid) {
            vacuumProducts.forEach(product => {
                ...
                card.innerHTML = `
                    <img src="${product.image}" alt="${product.name} | Industrial Dust Bin | Hygiene Apparatus & Service" class="product-card-image" />
