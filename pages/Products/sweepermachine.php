...
<head>
    ...
    <title>Commercial Sweeper Machines | Industrial Floor Sweeping Machines | Hygiene Apparatus & Service</title>
    <meta name="description"
        content="Discover commercial sweeper machines for efficient indoor and outdoor floor cleaning in warehouses, factories, parking areas, shopping malls and industrial facilities from Hygiene Apparatus & Service.">

    <meta name="keywords"
        content="Commercial Sweeper Machine, Industrial Sweeper Machine, Floor Sweeper, Walk Behind Sweeper, Warehouse Sweeper, Industrial Cleaning Machine, Cleaning Equipment, Hygiene Apparatus & Service">

    <meta name="author" content="Hygiene Apparatus & Service">

    <meta name="robots" content="index, follow">

    <link rel="canonical" href="https://hygieneapparattus.com/pages/Products/sweepermachine.php">

    <meta property="og:type" content="website">

    <meta property="og:title" content="Commercial Sweeper Machines | Hygiene Apparatus & Service">

    <meta property="og:description"
        content="Professional commercial sweeper machines for industrial and commercial floor cleaning.">

    <meta property="og:url" content="https://hygieneapparattus.com/pages/Products/sweepermachine.php">

    <meta property="og:image" content="https://hygieneapparattus.com/pages/assets/Sweepermachine/HAP55.png">

    <meta name="twitter:card" content="summary_large_image">

    <meta name="twitter:title" content="Commercial Sweeper Machines">

    <meta name="twitter:description"
        content="Premium commercial sweeper machines for warehouses, factories, shopping malls and industrial cleaning.">
...
<body>
    ...
    <div class="product-page">
        ...
        <section class="product-hero">
            <h1>Commercial <span>Sweeper Machines</span></h1>

            <p>
                Explore our range of commercial sweeper machines designed for efficient floor sweeping in warehouses,
                factories, parking areas, shopping malls, industrial facilities and commercial spaces. Built for
                durability, high performance and professional cleaning applications.
            </p>
        </section>
        ...
        <div class="product-grid-container">
            <div class="product-grid-title">
                ...
                Our Commercial Sweeper Machines
            </div>
    ...
    <script>
        ...
        const vacuumProducts = [{
            name: "HAP 55",
            image: "../assets/Sweepermachine/HAP55.png",
            page: "../ProductDetail/Sweepermachine/HAP55.php"

        },
        {
            name: "HAP 101",
            image: "../assets/Sweepermachine/HAP101.png",
            page: "../ProductDetail/Sweepermachine/HAP101.php"

        },
        {
            name: "HAP 102",
            image: "../assets/Sweepermachine/HAP102.png",
            page: "../ProductDetail/Sweepermachine/HAP102.php"
        ...
        if (grid) {
            vacuumProducts.forEach(product => {
                ...
                card.innerHTML = `
                    <img src="${product.image}" alt="${product.name} | Commercial Sweeper Machine | Hygiene Apparatus & Service" class="product-card-image" />
