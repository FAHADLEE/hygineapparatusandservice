...
<head>
    ...
    <title>Contact Hygiene Apparatus & Service | Commercial Cleaning Equipment Chennai</title>
    <meta name="description"
        content="Contact Hygiene Apparatus & Service for commercial cleaning machines, vacuum cleaners, scrubber machines, sweepers, pressure washers, spare parts and maintenance services in Chennai.">

    <meta name="keywords"
        content="Contact Hygiene Apparatus, Commercial Cleaning Equipment Chennai, Vacuum Cleaner Supplier Chennai, Scrubber Machine Dealer, High Pressure Washer Supplier, Cleaning Equipment Contact">

    <meta name="author" content="Hygiene Apparatus & Service">

    <meta name="robots" content="index, follow">

    <link rel="canonical" href="https://hygieneapparattus.com/pages/Contact/contact.php">

    <meta property="og:type" content="website">

    <meta property="og:title" content="Contact Hygiene Apparatus & Service">

    <meta property="og:description"
        content="Get in touch with Hygiene Apparatus & Service for commercial cleaning equipment, sales, support and maintenance services.">

    <meta property="og:url" content="https://hygieneapparattus.com/pages/Contact/contact.php">

    <meta property="og:image"
        content="https://hygieneapparattus.com/pages/assets/IMG_3730,JPG-Picsart-BackgroundRemover.png">

    <meta name="twitter:card" content="summary_large_image">

    <meta name="twitter:title" content="Contact Hygiene Apparatus & Service">

    <meta name="twitter:description"
        content="Contact us for commercial cleaning equipment, spare parts and professional maintenance services.">
...
<body>
    ...
    <nav class="navbar" id="navbar">
        ...
        <div class="nav-menu" id="navMenu">
            ...
            <a href="./contact.php" class="nav-link active" data-idx="3">Contact</a>
    ...
    <div class="contact-pages">
        <div class="container">
            ...
            <div class="contact-header">
                ...
                <p>
                    Have questions, need support, or want to schedule a service? We're here to help.
                </p>
            </div>
            ...
            <div class="contact-grid">
                ...
                <div class="contact-info-side">
                    ...
                    <div class="info-card">
                        ...
                        <div class="content">
                            <h4>Location</h4>
                            <p>No 15/69 Union Street Thelliyar Agaram, Porur Chennai-600116 Iyyappanthangal, Chennai, Tamil Nadu
                                600056</p>
            ...
            <div class="content">
              <h4>Working Hours</h4>
              <p>Monday - Saturday</p>
              <div class="sub-text">9:00 AM - 6:00 PM</div>
            </div>
          </div>
    ...
    <script type="application/ld+json">
    {
        ...
        "telephone": "+91 86677 95012",
        "email": "hygineapparatus@gmail.com",
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "No 15/69 Union Street, Thelliyar Agaram",
